                ...
                if(box&&box.getChildByName(name)){
                    switch (type) {
                        ...
                        case 'scale':
                            ...
                            if(this.isFloat(e)){
                                obj.scale = parseFloat(e).toFixed(1);
                                box.getChildByName(name).scale.set(obj.scale);
                            }
                            break;
                        case 'text':
                            ...
                            console.log('lllllllll',text.length,obj);
            ...
            uploadAnimation(index, name, e,optindex) {
                ...
                this.$http.post('/uploadingAnimation', object, {
                    ...
                    if(name === 'option'){
                        ...
                        let text_bg = this.gameData[index][name][optindex].text_bg ? this.gameData[index][name][optindex].text_bg : 'image_pao_img';
                        let qipao_scale = this.gameData[index][name][optindex].qipao_scale ? this.gameData[index][name][optindex].qipao_scale : 1;
                        let qipao_text = this.gameData[index][name][optindex].qipao_text ? this.gameData[index][name][optindex].qipao_text : 48;
                        UploadAndRenderEle(this.index,name+optindex,res,this.allData,text,text_bg,qipao_scale,qipao_text);
                    }
                    e.target.value = '';
                    this.updateResourceData();
                })
